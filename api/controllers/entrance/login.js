...
and exposed as \`req.me\`.)`,
  ...
  fn: async function ({ emailAddress, password, rememberMe }, exits) {
    emailAddress = emailAddress.toLowerCase();
    let that = this;
    let initiateAuthParams = {
      AuthFlow: "ADMIN_NO_SRP_AUTH",
      ClientId: sails.config.custom.COGNITO_CLIENT_ID_LOGIN,
    ...
    sails.config.custom.cognitoidentityserviceprovider.adminInitiateAuth(
      initiateAuthParams,
      function (err, dataInitiateAuth) {
        if (err) {
